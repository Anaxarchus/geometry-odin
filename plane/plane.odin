...
from_points :: proc "contextless" (p0, p1, p2: [3]$T) -> [4]T where is_float(T) {
	v := p1 - p0
	w := p2 - p0
...
normal :: #force_inline proc "contextless" (p: [4]$T) -> [3]T where is_float(T) {
	return p.xyz
}

// returns the signed distance from a point to the plane
distance :: #force_inline proc "contextless" (
	plane: [4]$T,
	point: [3]T,
) -> T where is_float(T) {
...
project :: #force_inline proc "contextless" (
	plane: [4]$T,
	point: [3]T,
...
is_above :: #force_inline proc "contextless" (
	plane: [4]$T,
	point: [3]T,
...
is_equal_approx :: proc "contextless" (
	a, b: [4]$T,
) -> bool where is_float(T) {
